...
# This is a little function written by Bryce Acree and used in the ICPSR summer
# workshop on machine learning. It helps evaluate the performance of doc classification algos

performance <- function(true,predicted){
  ...
  # calculation of the precision of the model
  precision <- a/(a+b)
  
  # calculation of the recall of the model
  recall <- a/(a+c)
  
  # caculation of the f.measure of the model
  ...
  return(list("precision"=precision,"recall"=recall,
              "f.measure"=f.measure,"accuracy"=accuracy))
}
